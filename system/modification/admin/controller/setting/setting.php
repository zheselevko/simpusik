...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['heading_title'] = $this->language->get('heading_title');
			...
			$data['entry_testimonial_mail'] = $this->language->get('entry_testimonial_mail');
			...
			$data['help_testimonial_mail'] = $this->language->get('help_testimonial_mail');
			$data['entry_testimonial_status'] = $this->language->get('entry_testimonial_status');
			$data['entry_testimonial_title'] = $this->language->get('entry_testimonial_title');
			$data['entry_testimonial_city'] = $this->language->get('entry_testimonial_city');
			$data['entry_testimonial_name'] = $this->language->get('entry_testimonial_name');
			$data['entry_testimonial_email'] = $this->language->get('entry_testimonial_email');
			$data['entry_testimonial_good'] = $this->language->get('entry_testimonial_good');
			$data['entry_testimonial_bad'] = $this->language->get('entry_testimonial_bad');
		...
		if (isset($this->request->post['config_phone1'])) {
			$data['config_phone1'] = $this->request->post['config_phone1'];
		} else {
			$data['config_phone1'] = $this->config->get('config_phone1');
		}

		if (isset($this->request->post['config_phone2'])) {
			$data['config_phone2'] = $this->request->post['config_phone2'];
		} else {
		...
		if (isset($this->request->post['config_google_captcha_status'])) {
			...
			$data['config_google_captcha_status'] = $this->config->get('config_google_captcha_status');
				...
				if (isset($this->request->post['config_testimonial_guest'])) {
					$data['config_testimonial_guest'] = $this->request->post['config_testimonial_guest'];
				} else {
					$data['config_testimonial_guest'] = $this->config->get('config_testimonial_guest');
				}

				if (isset($this->request->post['config_testimonial_mail'])) {
					$data['config_testimonial_mail'] = $this->request->post['config_testimonial_mail'];
				} else {
					$data['config_testimonial_mail'] = $this->config->get('config_testimonial_mail');
				}
				
				if (isset($this->request->post['config_testimonial_status'])) {
					$data['config_testimonial_status'] = $this->request->post['config_testimonial_status'];
				} else {
					$data['config_testimonial_status'] = $this->config->get('config_testimonial_status');
				}
				
				if (isset($this->request->post['config_testimonial_title'])) {
					$data['config_testimonial_title'] = $this->request->post['config_testimonial_title'];
				} else {
					$data['config_testimonial_title'] = $this->config->get('config_testimonial_title');
				}
				
				if (isset($this->request->post['config_testimonial_city'])) {
					$data['config_testimonial_city'] = $this->request->post['config_testimonial_city'];
				} else {
					$data['config_testimonial_city'] = $this->config->get('config_testimonial_city');
				}
				
				if (isset($this->request->post['config_testimonial_text'])) {
					$data['config_testimonial_text'] = $this->request->post['config_testimonial_text'];
				} else {
					$data['config_testimonial_text'] = $this->config->get('config_testimonial_text');
				}
				
				if (isset($this->request->post['config_testimonial_email'])) {
					$data['config_testimonial_email'] = $this->request->post['config_testimonial_email'];
				} else {
					$data['config_testimonial_email'] = $this->config->get('config_testimonial_email');
				}
				
				if (isset($this->request->post['config_testimonial_name'])) {
					$data['config_testimonial_name'] = $this->request->post['config_testimonial_name'];
				} else {
					$data['config_testimonial_name'] = $this->config->get('config_testimonial_name');
				}
				
				if (isset($this->request->post['config_testimonial_good'])) {
					$data['config_testimonial_good'] = $this->request->post['config_testimonial_good'];
				} else {
					$data['config_testimonial_good'] = $this->config->get('config_testimonial_good');
				}
				
				if (isset($this->request->post['config_testimonial_bad'])) {
					$data['config_testimonial_bad'] = $this->request->post['config_testimonial_bad'];
				} else {
					$data['config_testimonial_bad'] = $this->config->get('config_testimonial_bad');
				}
				
				if (isset($this->request->post['config_testimonial_rating'])) {
					$data['config_testimonial_rating'] = $this->request->post['config_testimonial_rating'];
				} else {
					$data['config_testimonial_rating'] = $this->config->get('config_testimonial_rating');
				}
				
				if (isset($this->request->post['config_testimonial_limit'])) {
					$data['config_testimonial_limit'] = $this->request->post['config_testimonial_limit'];
				} 
				else {
					if ((int)$this->config->get('config_testimonial_limit') == 0) {
						$data['config_testimonial_limit'] = 10;
					} 
					else {
						$data['config_testimonial_limit'] = $this->config->get('config_testimonial_limit');
					}
				}
