  ...
  <ul class="nav pull-right">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-refresh  fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        <li><a href="<?php echo $refresh; ?>" data-toggle="tooltip" title="<?php echo $button_refresh; ?>"><i class="fa fa-refresh"></i>&nbsp;&nbsp;<?php echo $button_refresh; ?></a></li>
        <li><a href="<?php echo $clear; ?>" data-toggle="tooltip" title="<?php echo $button_clear; ?>"><i class="fa fa-eraser"></i>&nbsp;&nbsp;<?php echo $button_clear; ?></a></li>
      </ul>
    </li>
