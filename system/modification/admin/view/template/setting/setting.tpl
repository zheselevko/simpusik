        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-phone1"><?php echo $entry_phone1; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_phone1" value="<?php echo $config_phone1; ?>" placeholder="<?php echo $entry_phone1; ?>" id="input-phone1" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-phone2"><?php echo $entry_phone2; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_phone2" value="<?php echo $config_phone2; ?>" placeholder="<?php echo $entry_phone2; ?>" id="input-phone2" class="form-control" />
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-option">
			  ...
			  <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_testimonial_guest) { ?>
                      <input type="radio" name="config_testimonial_guest" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_testimonial_guest" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_testimonial_guest) { ?>
                      <input type="radio" name="config_testimonial_guest" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_testimonial_guest" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_testimonial_mail; ?>"><?php echo $entry_testimonial_mail; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_testimonial_mail) { ?>
                      <input type="radio" name="config_testimonial_mail" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_testimonial_mail" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_testimonial_mail) { ?>
                      <input type="radio" name="config_testimonial_mail" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_testimonial_mail" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label"><?php echo $entry_testimonial_status; ?></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_testimonial_status) { ?>
                      <input type="radio" name="config_testimonial_status" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_testimonial_status" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_testimonial_status) { ?>
                      <input type="radio" name="config_testimonial_status" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_testimonial_status" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label" for="input-testimonial-title"><?php echo $entry_testimonial_title; ?></label>
                  <div class="col-sm-10">
                    <select name="config_testimonial_title" id="input-testimonial-title" class="form-control">
					  <option value="2" 
					  <?php 
					  if ($config_testimonial_title == '2') { 
					      echo 'selected="selected"';  
					  } 
					  ?>><?php echo $text_required; ?></option>
                      <option value="1" 
					  <?php 
					  if ($config_testimonial_title == '1') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_no_required; ?></option>
					  <option value="0" 
					  <?php 
					  if ($config_testimonial_title == '0') { 
					      echo 'selected="selected"';  
					  }
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label" for="input-testimonial-city"><?php echo $entry_testimonial_city; ?></label>
                  <div class="col-sm-10">
                    <select name="config_testimonial_city" id="input-testimonial-city" class="form-control">
					  <option value="2" 
					  <?php 
					  if ($config_testimonial_city == '2') { 
					      echo 'selected="selected"';  
					  } 
					  ?>><?php echo $text_required; ?></option>
                      <option value="1" 
					  <?php 
					  if ($config_testimonial_city == '1') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_no_required; ?></option>
					  <option value="0" 
					  <?php 
					  if ($config_testimonial_city == '0') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_disabled; ?></option>
                    </select>
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label" for="input-testimonial-name"><?php echo $entry_testimonial_name; ?></label>
                  <div class="col-sm-10">
                    <select name="config_testimonial_name" id="input-testimonial-name" class="form-control">
					  <option value="2" 
					  <?php 
					  if ($config_testimonial_name == '2') { 
					      echo 'selected="selected"';  
					  } 
					  ?>><?php echo $text_required; ?></option>
                      <option value="1" 
					  <?php 
					  if ($config_testimonial_name == '1') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_no_required; ?></option>
					  <option value="0" 
					  <?php 
					  if ($config_testimonial_name == '0') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_disabled; ?></option>
                    </select>
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label" for="input-testimonial-email"><?php echo $entry_testimonial_email; ?></label>
                  <div class="col-sm-10">
                    <select name="config_testimonial_email" id="input-testimonial-email" class="form-control">
					  <option value="2" 
					  <?php 
					  if ($config_testimonial_email == '2') { 
					      echo 'selected="selected"';  
					  } 
					  ?>><?php echo $text_required; ?></option>
                      <option value="1" 
					  <?php 
					  if ($config_testimonial_email == '1') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_no_required; ?></option>
					  <option value="0" 
					  <?php 
					  if ($config_testimonial_email == '0') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_disabled; ?></option>
                    </select>
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label" for="input-testimonial-text"><?php echo $entry_testimonial_text; ?></label>
                  <div class="col-sm-10">
                    <select name="config_testimonial_text" id="input-testimonial-text" class="form-control">
					  <option value="2" 
					  <?php 
					  if ($config_testimonial_text == '2') { 
					      echo 'selected="selected"';  
					  } 
					  ?>><?php echo $text_required; ?></option>
                      <option value="1" 
					  <?php 
					  if ($config_testimonial_text == '1') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_no_required; ?></option>
					  <option value="0" 
					  <?php 
					  if ($config_testimonial_text == '0') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_disabled; ?></option>
                    </select>
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label" for="input-testimonial-good"><?php echo $entry_testimonial_good; ?></label>
                  <div class="col-sm-10">
                    <select name="config_testimonial_good" id="input-testimonial-good" class="form-control">
					  <option value="2" 
					  <?php 
					  if ($config_testimonial_good == '2') { 
					      echo 'selected="selected"';  
					  } 
					  ?>><?php echo $text_required; ?></option>
                      <option value="1" 
					  <?php 
					  if ($config_testimonial_good == '1') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_no_required; ?></option>
					  <option value="0" 
					  <?php 
					  if ($config_testimonial_good == '0') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_disabled; ?></option>
                    </select>
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label" for="input-testimonial-bad"><?php echo $entry_testimonial_bad; ?></label>
                  <div class="col-sm-10">
                    <select name="config_testimonial_bad" id="input-testimonial-bad" class="form-control">
					  <option value="2" 
					  <?php 
					  if ($config_testimonial_bad == '2') { 
					      echo 'selected="selected"';  
					  } 
					  ?>><?php echo $text_required; ?></option>
                      <option value="1" 
					  <?php 
					  if ($config_testimonial_bad == '1') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_no_required; ?></option>
					  <option value="0" 
					  <?php 
					  if ($config_testimonial_bad == '0') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_disabled; ?></option>
                    </select>
				...
				<div class="form-group">
                  <label class="col-sm-2 control-label" for="input-testimonial-rating"><?php echo $entry_testimonial_rating; ?></label>
                  <div class="col-sm-10">
                    <select name="config_testimonial_rating" id="input-testimonial-rating" class="form-control">
                      <option value="1" 
					  <?php 
					  if ($config_testimonial_rating == '1') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_enabled; ?></option>
					  <option value="0" 
					  <?php 
					  if ($config_testimonial_rating == '0') { 
					      echo 'selected="selected"';  
					  }
					  ?>><?php echo $text_disabled; ?></option>
                    </select>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input type="text" name="config_testimonial_limit" value="<?php echo $config_testimonial_limit; ?>" placeholder="<?php echo $entry_testimonial_limit; ?>" id="input-testimonial-limit" class="form-control" />
                  </div>
                </div>
              </fieldset>
