...
// Text
			...
			$_['entry_testimonial_city']               = 'City';
			$_['entry_testimonial_title']              = 'Title';
			$_['entry_testimonial_name']               = 'Name';
			$_['entry_testimonial_email']              = 'E-mail';
			$_['entry_testimonial_text']               = 'Text';
			$_['entry_testimonial_good']               = 'Good';
			$_['entry_testimonial_bad']                = 'Bad';
			$_['entry_testimonial_rating']             = 'Rating';
			$_['entry_testimonial_guest']              = 'Allow Guest Testimonials';
			$_['entry_testimonial_mail']               = 'New Testimonial Alert Mail';
			$_['entry_testimonial_text']               = 'Type message';
			$_['entry_testimonial_limit']              = 'Limit testimonials';
			$_['help_testimonial']       	           = 'Enable/Disable new testimonial entry and display of existing testimonials.';
			$_['help_testimonial_guest']       	       = 'Allow guests to post testimonials.';
			$_['help_testimonial_mail']                = 'Send an email to the store owner when a new testimonial is created.';
			$_['entry_testimonial_status']             = 'Publication after validation';
