...
//            }
        ...
        $prices = $this->getPricesByCategoryData($data['filter_category_id']);
        $this->_data['price_min'] = $prices['prices']['price_min'];
        $this->_data['price_max'] = $prices['prices']['price_max'];
	...
	public function getPricesByCategoryData($category_id) {
