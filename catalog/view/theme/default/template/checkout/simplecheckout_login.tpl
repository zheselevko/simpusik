    ...
    <div class="simplecheckout-block-content">
        ...
        <table class="simplecheckout-login">
            <tr>
                ...
                <td class="simplecheckout-login-right"><input data-onkeydown="detectEnterAndLogin" type="text" name="email" value="<?php echo $email; ?>" /></td>
            </tr>
            <tr>
                <td class="simplecheckout-login-left"><?php echo $entry_password; ?></td>
                <td class="simplecheckout-login-right"><input data-onkeydown="detectEnterAndLogin" type="password" name="password" value="" /></td>
            </tr>
            <tr>
                <td></td>
