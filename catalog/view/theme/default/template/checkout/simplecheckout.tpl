...
<div class="simple-content section block-cart">
<?php } ?>
    ...
    <div id="simplecheckout_form_<?php echo $group ?>" <?php echo $display_error && $has_error ? 'data-error="true"' : '' ?> <?php echo $logged ? 'data-logged="true"' : '' ?>>
        <div class="simplecheckout">
            <?php if (!$cart_empty) { ?>
                ...
                <?php
                    $replace = array(
                        '{left_column}'      => '<div class="col s12 m5">',
                        '{/left_column}'     => '</div>',
                        '{right_column}'     => '<div class="col s12 m7">',
                        '{/right_column}'    => '</div>',
                        '{step}'             => '<div class="simplecheckout-step">',
                        '{/step}'            => '</div>',
                        '{row_column}'       => '<div class="buyer-info-form"><h2>Укажите информацию о покупателе</h2><div class="row">',
                        '{/row_column}'      => '</div></div>',
                ...
                <?php if (!$block_order) { ?>
				    ...
				    <div class="row">
					    <div class="col s12 center-align">
						    <div class="buyer-info-form__buttons center-align">
                                <button class="btn-large btn-orange bold waves-effect waves-light" type="submit" data-onclick="createOrder" id="simplecheckout_button_confirm">Оформить заказ</button>
                            </div>
						</div>
					</div>
            ...
            <?php } else { ?>
				...
				<div class="row">
				    <div class="col s12 center-align">
					    <div class="buyer-info-form__buttons center-align">
                            <a href="/" class="btn-large btn-orange bold waves-effect waves-light" type="button"><?php echo $button_continue; ?></a>
                        </div>
					</div>
				</div>
            <?php } ?>
