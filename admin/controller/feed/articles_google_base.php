...
class ControllerFeedArticlesGoogleBase extends Controller {
	...
	public function index() {
		...
		$data['action'] = $this->url->link('feed/articles_google_base', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['data_feed'] = HTTP_CATALOG . 'index.php?route=feed/articles_google_base';

		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');

		$this->response->setOutput($this->load->view('feed/articles_google_base.tpl', $data));
	} 
