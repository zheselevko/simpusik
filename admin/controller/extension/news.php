...
class ControllerExtensionNews extends Controller {
	...
	public function index() {
		...
		$data['text_terminate'] = $this->language->get('text_terminate');
	...
	protected function form() {
		...
		if (isset($this->request->post['date_end'])) {
			...
			$data['date_end'] = ($news['date_end'] != '0000-00-00') ? $news['date_end'] : '';
		} else {
		...
		if (isset($this->request->post['news_related'])) {
			...
			$products = $this->model_extension_news->getNewsRelated($this->request->get['news_id']);
		} else {
			$products = array();
		}
