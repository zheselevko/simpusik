		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
							...
							<div id="tab-language-validate-<?php echo $language['language_id']; ?>" class="tab-pane">
								<div class="form-group required">
									...
									<div class="col-sm-2">
										...
										<textarea id="field-error-message-<?php echo $language['language_id']; ?>" class="form-control" name="field[validate][option][captcha][error_message][<?php echo $language['language_id']; ?>]" rows="3" cols="65"><?php if  (isset($validate_option['captcha']['error_message'][$language['language_id']])) echo $validate_option['captcha']['error_message'][$language['language_id']]; ?></textarea>
										<?php if (isset($error['validate']['captcha']['error_message'][$language['language_id']])) { ?>
										<div class="text-danger"><?php echo $error['validate']['captcha']['error_message'][$language['language_id']]; ?></div>
										<?php } ?>
									</div>
								</div>
							</div>
					...
					<input type="hidden" name="field[type][type]" value="text" />
					<input type="hidden" name="field[validate][type]" value="captcha" />
