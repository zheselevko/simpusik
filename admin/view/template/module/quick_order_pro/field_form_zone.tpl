					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<p class="form-control-static"><?php echo $country_info['name']; ?></p>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="field-zone-id"><?php echo $entry_zone; ?></label>
								<div class="col-sm-2">
									<select id="field-zone-id" class="form-control" name="field[zone_id]" >
										<option value="0"><?php echo $text_none; ?></option>
										<?php foreach ($zones as $zone_info) { ?>
										<option <?php if ($zone_id == $zone_info['zone_id']) echo 'selected="selected"'; ?> value="<?php echo $zone_info['zone_id']; ?>"><?php echo $zone_info['name']; ?></option>
										<?php } ?>
									</select>
								</div>
							</div>
