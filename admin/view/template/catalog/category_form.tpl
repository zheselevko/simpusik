            ...
            <div class="tab-pane active in" id="tab-general">
              ...
              <div class="tab-content">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
                    <input type="text" name="category_description[<?php echo $language['language_id']; ?>][seo_h1]" value="<?php echo isset($category_description[$language['language_id']]['seo_h1']) ? $category_description[$language['language_id']]['seo_h1'] : ''; ?>" id="input-h1-title<?php echo $language['language_id']; ?>" class="form-control" placeholder="Enter Seo H1" />
                  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
                    <input type="text" name="category_description[<?php echo $language['language_id']; ?>][seo_h2]" value="<?php echo isset($category_description[$language['language_id']]['seo_h2']) ? $category_description[$language['language_id']]['seo_h2'] : ''; ?>" id="input-h1-title<?php echo $language['language_id']; ?>" class="form-control" placeholder="Enter Seo H2" />
                  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
                    <input type="text" name="category_description[<?php echo $language['language_id']; ?>][seo_h3]" value="<?php echo isset($category_description[$language['language_id']]['seo_h3']) ? $category_description[$language['language_id']]['seo_h3'] : ''; ?>" id="input-h1-title<?php echo $language['language_id']; ?>" class="form-control" placeholder="Enter Seo H3" />
                  </div>
				</div>
				
				<div class="form-group">
                  <label class="col-sm-2 control-label" for="input-seo_title-title<?php echo $language['language_id']; ?>">Seo Title</label>
                  <div class="col-sm-10">
                    <input type="text" name="category_description[<?php echo $language['language_id']; ?>][seo_title]" value="<?php echo isset($category_description[$language['language_id']]['seo_title']) ? $category_description[$language['language_id']]['seo_title'] : ''; ?>" id="input-seo_title-title<?php echo $language['language_id']; ?>" class="form-control" placeholder="Enter Seo Title" /></div></div><div class="form-group">
                </div>
				<!-- * = * -->
