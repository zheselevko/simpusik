              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($testimonial['testimonial_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
				  <td class="text-left col-md-1"><?php echo $testimonial['name']; ?></td>
				  <td class="text-center col-md-1"><?php echo $testimonial['rating']; ?></td>
				  <td class="text-left col-md-8"><?php echo $testimonial['text']; ?></td>
				  <td class="text-left col-md-1"><?php echo $testimonial['date_added']; ?></td>
				  <td class="text-left col-md-1"><?php echo $testimonial['status']; ?></td>
				  <td class="text-right col-md-1"><a href="<?php echo $testimonial['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
