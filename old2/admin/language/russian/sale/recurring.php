...
// Text
$_['text_success']                         = 'Периодические заказы изменены!';
$_['text_list']                            = 'Список Периодических заказов';
$_['text_add']                             = 'Добавление профиля периодических заказов';
$_['text_edit']                            = 'Редактировать профиль периодических заказов';
$_['text_payment_profiles']                = 'Профили периодических заказов';
...
$_['entry_recurring']                      = 'Профиль периодического заказа';
$_['entry_payment_method']                 = 'Способ оплаты';

// Error / Success
$_['error_not_cancelled']                  = 'Ошибка: %s';
$_['error_not_found']                      = 'Не возможно отменить профиль периодического заказа';
$_['text_cancelled']                       = 'Периодический заказ был отменен';
